...
EMAIL_ENABLED = CONSTANCE_CONFIG["EMAIL_ENABLED"][0]
EMAIL_HOST = CONSTANCE_CONFIG["EMAIL_HOST"][0]
EMAIL_PORT = CONSTANCE_CONFIG["EMAIL_PORT"][0]
EMAIL_HOST_USER = CONSTANCE_CONFIG["EMAIL_HOST_USER"][0]
EMAIL_HOST_PASSWORD = CONSTANCE_CONFIG["EMAIL_HOST_PASSWORD"][0]
EMAIL_USE_TLS = CONSTANCE_CONFIG["EMAIL_USE_TLS"][0]
EMAIL_USE_SSL = CONSTANCE_CONFIG["EMAIL_USE_SSL"][0]
DEFAULT_FROM_EMAIL = CONSTANCE_CONFIG["EMAIL_DEFAULT_FROM"][0]
