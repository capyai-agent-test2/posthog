...
from posthog.remote_config import config_endpoint, config_js_endpoint
...
urlpatterns = [
    ...
    *ee_urlpatterns,
    ...
    path("array/<str:token>/config", config_endpoint),
    path("array/<str:token>/config.js", config_js_endpoint),
