...
export const API_SCOPES: APIScope[] = [
    ...
    { key: 'batch_import', objectName: 'Batch import', objectPlural: 'batch imports' },
    ...
    { key: 'external_data_schema', objectName: 'External data schema', objectPlural: 'external data schemas' },
    ...
    { key: 'warehouse_objects', objectName: 'Warehouse object', objectPlural: 'warehouse objects' },
